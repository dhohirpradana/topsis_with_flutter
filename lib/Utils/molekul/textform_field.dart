                  ...
                  child: Padding(
                    ...
                    child: Theme(
                      ...
                      child: DropdownButton(
                        elevation: 0,
                        hint: _dropDownTinggiValue == null
                            ? Text('0 cm')
                            : Text(
                                _dropDownTinggiValue + ' cm',
                        ...
                        onChanged: (val) {
                          ...
                          setState(
                            () {
                              topsis[i]['c1'.toString()] =
                                  tinggi.indexOf(val.toString()) + 1;
                              // int.parse(val.toString());
                              _dropDownTinggiValue = val.toString();
                            },
                          );
                        },
                      ),
